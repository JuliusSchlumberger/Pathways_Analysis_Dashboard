...
def create_pathways_maps(focus, line_choice, input_with_pathways, file_offset, file_base,
    ...
    if interaction_identifier:
        input_file_with_pathways_with_interaction = f'{interaction_identifier}.txt'
        file_sequence_only_with_interaction = f'{interaction_identifier}_only_sequences.txt'
        file_tipping_points_with_interaction = f'{interaction_identifier.replace("all_sequences", "all_tp_timings")}.txt'
