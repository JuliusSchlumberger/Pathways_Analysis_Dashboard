...
#     return 'Please submit your response.', is_open, ""
#
# # Callback for the pathways robustness section
# @app.callback(
#     Output('pathways_robustness-container', 'children'),
#     Output('modal-robustness', 'is_open'),
#     Output('modal-body-robustness', 'children'),
#     Input('submit-survey-pathways_robustness', 'n_clicks'),
#     [State('color-input', 'value'), State('crop_loss-input', 'value'), State('robustness-input', 'value'),
#      State('tradeoff-input', 'value'), State('storage-general', 'data')],
#     State("modal-robustness", "is_open")
# )
# def save_answers_robustness(n_clicks, color, crop_loss, robustness, tradeoff, session_id, is_open):
#     if n_clicks > 0:
#         missing_fields = []
#         if color is None:
...
#             missing_fields.append("Robustness")
#         if tradeoff is None:
...
#             return 'Please complete all required fields before submitting.', True, f"The following fields are missing: {missing_fields_str}"
#         else:
#             data = {"color": color, "crop_loss": crop_loss, "robustness": robustness, "tradeoff": tradeoff}
#             save_response_to_db(session_id['existing_id'], "pathways_robustness", data)
#             return f'Your response has been saved ({n_clicks}).', False, ""
#     return 'Please submit your response.', is_open, ""
#
