...
def update_pathways_graph(pathname, map_scenario, interacting_sectors, stored_data, viewport):
    ...
    print('create pathways grap', triggered_id)
    if not ctx.triggered:
        ...
        if pathname == '/3-pathways-maps':
            ...
            if storage['sectoral_interactions_maps'] == None or storage['sectoral_interactions_maps'] == 'no_interactions':
                fig = generate_pathways_map([storage['scenarios']], risk_owner_hazard, interacting_sector_string=False)
                ...
                fig = generate_pathways_map([storage['scenarios']], risk_owner_hazard, interacting_sector_string=interacting_sector_string)
    #
