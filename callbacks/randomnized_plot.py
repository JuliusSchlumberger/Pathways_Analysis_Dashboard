...
#     prevent_initial_call=True
# )
# def update_dropdown_options(pathname, option, stored_data):
#     if pathname == '/2-pathways-robustness':
#         # survey version
#         # if stored_data.get('robustness_plot', None) == None:
#         #     random_key = random.choice(list(WHICH_OPTIONS.keys()))
#         #     # random_key = list(WHICH_OPTIONS.keys())[1]
#         #     # random_key = 'Parallel Coordinates Plot'
#         stored_data['robustness_plot'] = WHICH_OPTIONS[option]
#         print(option)
#         #     stored_data['drop_down_option'] = {random_key: WHICH_OPTIONS[random_key]}
#         # stored_data['drop_down_option'] = WHICH_OPTIONS
#
...
#             ]
#
#         return stored_data, fig_description  # Return options for page-1
#     else:
#         return dash.no_update, dash.no_update   # Return empty list if the dropdown isn't rendered (this will be ignored)
#
