...
#            "This plot can uncover relationships between robustness criteria and identify clusters of similar pathways. "
...
#                   'total length indicates better robustness, allowing you to quickly compare overall robustness '
#                   'across different pathways options. To interpret this chart, examine the lengths of the bars to '
#                   'gauge robustness, and look at the segments within each bar to understand the contribution of '
...
#
# @app.callback(
#     [Output("robustness_figure-modal", "is_open"), Output("modal-body-robustness_figure", "children")],
#     [Input("open-modal-robustness_figure", "n_clicks"), Input('options', 'value'),
#      Input("close-modal-robustness_figure", "n_clicks")],
#     [State("robustness_figure-modal", "is_open")],
# )
# def toggle_modal_and_set_content_robustness_figure(open_clicks, plot_type, close_clicks, is_open):
#     triggered_id = callback_context.triggered[0]['prop_id'].split('.')[0]
#
#     # Handle Modal Opening
#     if triggered_id == "open-modal-robustness_figure" and open_clicks:
#         if plot_type:
...
#     elif triggered_id == "close-modal-robustness_figure" and close_clicks:
